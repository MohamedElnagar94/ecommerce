...
@section('heading','تعديل البيانات المهنية')
@section('content')
    <!-- ================ start profile ========================== -->
            ...
            <div class="col-md-3 bg_main text-center color-white">
                ...
                <div class="text-right mb-5">
                    <ul class="list-unstyled list_profile">
                        ...
                        <li><a class="active" href="profile modify the data.html"><i class="far fa-edit"></i>تعديل البيانات المهنية</a></li>
                ...
                <div class="p-3">
                    <div class="w-100 text-right mb-3">
                        <div class="w-100 color_main">
                            <div class="font-weight-bolder h5"><i class="far fa-edit ml-2"></i>تعديل البيانات المهنية</div>
                            <hr class="color_main">
                        </div>
                    </div>
                    <section class="container-fluid">
                        <div class="container">
                            <form>
                                <div class="row text-center pb-3 pl-3 pr-3">
                                ...
                                <div class="pb-5 pl-3 pr-3 form-cv">
                                    <table class="table table-bordered table-mohelat">
