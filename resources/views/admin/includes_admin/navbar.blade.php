<header class="main-header">
    ...
    <a href="{{url('/')}}" class="logo">
        ...
        <span class="logo-lg"><b>Amazing</b> Color</span>
    </a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu" style="width:50px">
                    ...
                    <li class="body">Arabic</li>
                    <li class="body">English</li>
            ...
            <li class="dropdown messages-menu">
                ...
                <ul class="dropdown-menu">
                    ...
                    <ul class="menu">
                        ...
                        <a href="#">
                            <div class="pull-left">
                            <img src="{{url('/')}}/storage/admin/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                        ...
                        <a href="#">
                            <div class="pull-left">
                            <img src="{{url('/')}}/storage/admin/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                            </div>
                            <h4>
                            Developers
            ...
            <ul class="dropdown-menu">
                ...
                <p>
                    {{ admin()->user()->username }} - Web Developer
